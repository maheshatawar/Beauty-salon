  ...
  return (
    <main>
      <header className="site-header">
        ...
        <div className="header-actions"><a className="instagram-link" href="#instagram" aria-label="Luma and Co. on Instagram"><Camera size={18} strokeWidth={1.7} /></a><button className="button button-dark button-small" type="button" onClick={openBooking}>Book a visit <ArrowRight size={16} /></button><button className="menu-toggle" type="button" aria-label="Toggle navigation" onClick={() => setIsMenuOpen(!isMenuOpen)}>{isMenuOpen ? <X size={22} /> : <Menu size={22} />}</button></div>
      </header>
